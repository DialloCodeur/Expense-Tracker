        ...
        <div className="min-h-screen bg-linear-to-br from-white via-blue-50 to-indigo-100">
            ...
            <section className="max-w-7xl mx-auto px-6 py-20 md:py-32">
                <div className="text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                        <button className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition duration-200 shadow-lg hover:shadow-xl">
                            Get Started
                        </button>
            ...
            <section className="bg-linear-to-r from-indigo-600 to-teal-500 py-16 md:py-20">
                <div className="max-w-4xl mx-auto px-6 text-center text-white space-y-6">
                    ...
                    <button className="px-8 py-3 bg-white text-indigo-600 font-semibold rounded-lg hover:bg-gray-100 transition duration-200 inline-block">
                        Start Free Today
                    </button>
                </div>
            </section>
